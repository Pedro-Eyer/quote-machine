...
function QuoteMachine() {
  ...
  const quotes = [
    ...
    { text: "Não importa quantos passos você deu para trás, o importante é quantos passos você vai dar para frente.", author: "Provérbio Chinês" },
    ...
    { text: "Se você quer alcançar a grandeza, pare de pedir permissão.", author: "Cleber Martins" },
